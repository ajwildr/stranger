            ...
            <div class="col-md-8">
                <div class="details-section p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="mb-0"><?php echo htmlspecialchars(getValue($project, 'title')); ?></h2>
                        <?php 
                    ...
                    <div class="mb-4">
                        ...
                        <p><?php echo nl2br(htmlspecialchars(getValue($project, 'description'))); ?></p>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        <strong>Team:</strong> <?php echo htmlspecialchars(getValue($project, 'team_name')); ?>
                                    </p>
                                    <p class="mb-2">
                                        <i class="fas fa-user-tie me-2 text-primary"></i>
                                        <strong>Team Lead:</strong> <?php echo htmlspecialchars(getValue($project, 'team_lead')); ?>
                                    </p>
                                    <p class="mb-0">
                                        <i class="fas fa-user me-2 text-primary"></i>
                                        <strong>Created By:</strong> <?php echo htmlspecialchars(getValue($project, 'created_by_name')); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        <strong>Start Date:</strong> <?php echo formatDate(getValue($project, 'start_date')); ?>
                                    </p>
                                    <p class="mb-2">
                                        <i class="fas fa-calendar-check me-2 text-warning"></i>
                                        <strong>Due Date:</strong> <?php echo formatDate(getValue($project, 'due_date')); ?>
                                    </p>
                                    <?php if (getValue($project, 'actual_end_date')): ?>
                                        <p class="mb-0">
                                            <i class="fas fa-flag-checkered me-2 text-success"></i>
                                            <strong>Completed:</strong> <?php echo formatDate(getValue($project, 'actual_end_date')); ?>
                                        </p>
                                    <?php else: ?>
                                        <p class="mb-0">
                                            ...
                                            ?>
                                            <span class="badge bg-<?php echo $days_remaining < 0 ? 'danger' : 'info'; ?>">
                                ...
                                <div class="timeline-item">
                                    <div class="mb-2">
                                        <span class="badge bg-<?php 
                                            echo match(getValue($extension, 'status', 'pending')) {
                                                'approved' => 'success',
                                                'rejected' => 'danger',
                                                default => 'warning'
                                            };
                                    ...
                                    <p class="mb-1">
                                        <strong>Requested By:</strong> <?php echo htmlspecialchars(getValue($extension, 'requested_by_name')); ?>
                                    </p>
                                    <p class="mb-1">
                                        <strong>New Due Date:</strong> <?php echo formatDate(getValue($extension, 'new_due_date')); ?>
                                    </p>
                                    <p class="mb-1">
                                        <strong>Reason:</strong> <?php echo htmlspecialchars(getValue($extension, 'reason')); ?>
                                    </p>
                                    <?php if (getValue($extension, 'response_note')): ?>
                                        <p class="mb-0">
                                            <strong>Response:</strong> <?php echo htmlspecialchars(getValue($extension, 'response_note')); ?>
                                        </p>
                                    <?php endif; ?>
                                </div>
                            <?php endwhile; ?>
